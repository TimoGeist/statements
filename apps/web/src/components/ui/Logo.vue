<template>
    <svg class="w-9 h-9" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <g fill="none" class="stroke-foreground" stroke-linecap="round" stroke-width="2">
            <path d="M8.5 14.5h7.657"></path>
            <path d="M8.5 10.5h7.657"></path>
            <path d="M8.5 6.5h7.657"></path>
            <path d="M5.5 14.5h0"></path>
            <path d="M5.5 10.5h0"></path>
            <path d="M5.5 6.5h0"></path>
        </g>
        <path fill="none" class="stroke-foreground" stroke-linecap="round" stroke-width="2"
